      ...
      <b-card-body>
        <b-row class="my-2">
          ...
          >
            ...
            <!-- Avability -->
            <b-card-text>Có sẵn - <span class="text-success">Trong kho</span></b-card-text>
            ...
            <ul class="product-features list-unstyled">
              <li v-if="product.hasFreeShipping">
                ...
                <span>Miễn phí vận chuyển</span></li>
              <li>
                <feather-icon icon="DollarSignIcon" />
                <span>Các tùy chọn EMI có sẵn</span>
              </li>
            </ul>
            ...
            <div class="d-flex flex-column flex-sm-row pt-1">
              ...
              >
                <feather-icon
                  ...
                  class="mr-50"
                />
                <span>{{ product.isInCart ? 'Xem trong giỏ hàng' : 'Thêm vào giỏ hàng' }}</span>
              </b-button>
              <b-button
